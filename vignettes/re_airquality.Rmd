...
The objective of this report exercise is to practice visualizing data and using statistical metrics to tell a story from data. For this purpose I investigated the [*airquality*](https://www.rdocumentation.org/packages/datasets/versions/3.6.2/topics/airquality) data set with ozone as the target variable, which is publicly available and consists of daily measurements of environmental variables from May first to September 30th 1973 from New York (Table 1).
...
```
<center>
*Figure 1: Time series of daily ozone concentrations in New York in 1973 relative to the WHO threshold of 51 ppb (dashed line).*
</center>

<br>

Ozone varied greatly from day to day, with ozone concentrations ranging from 1 ppb on the 21st of May to 168 ppb on the 25th of August with an average daily concentration of 42 ppb, a median concentration of 32 ppb, and a standard deviation of 33 ppb. Higher average concentrations were observed in the summer months (June-August) with on average 55 ppb which is above the WHO threshold, and lower concentrations in spring (May) with 23 ppb and autumn (September) with 31 ppb on average (Figure 1). While ozone concentrations were almost exclusively below the WHO threshold of 51 in May and September, they were frequently severely above this threshold from June to August. Apart from this clear seasonal pattern, no trend over the whole time series was visible.
...
<br>
Figure 2 shows that all days of the week exceeding 51 ppb on average were in July and August, with 5 for both months. In July, the highest average concentrations were measured on Wednesday and in August on Saturday. July and August shared no pattern over the days of the week in exceeding 51 ppb of ozone. Taking all other months into account, weekdays and weekends were not consistent in their differences, with May showing higher concentrations during weekdays and June showing higher concentrations over the weekend. Fridays had consistently one of the lowest ozone concentrations in all months.

<br>

#### 3.2 Prediction of Ozone
 
From the three single predictors, temperatures linear model performed best at predicting ozone with an $R^2$ of 0.488 which indicates that roughly 50% of the variation of ozone can be modeled with just temperature (Table 2). The linear models of wind speed and solar radiation performed worse and were only poorly able to predict ozone concentrations.
...
Comparing the linear models visually, the temperature-ozone association indicates a non-linear relationship and shows increasing ozone concentrations with increasing temperature (Figure 3). There is a steep incline in ozone concentration at high temperatures where the model underestimates ozone concentrations. Wind speed as a predictor had an inverse association with ozone, as the highest concentrations occurred in low wind speed conditions. Wind speeds model also had wider confidence intervals than the temperature model, which again indicates poorer predictive ability. There is no clear visual pattern between ozone and solar radiation, supporting the very poor predictability of ozone shown in Table 2.
...
I hypothesized that ozone concentrations would be higher in the summer due to increased solar radiation, and I found a clear seasonal pattern with the highest concentrations in the summer months. However, I did not find the expected increased ozone concentration on weekdays, possibly due to other processes being involved in ozone production and decay than traffic and industry activity. Against expectations, solar radiation predicted ozone worse than wind speed and temperature, possibly because chemical concentrations rely more on temperature and wind speed, which accounts for a dilution of polluted air. Temperature performed best at linearly predicting ozone concentrations but was not sufficiently accurate to serve as a sole predictor in health monitoring programs. In conclusion, New York's population in 1973 was heavily exposed to dangerous ozone concentrations in the summer months, which often coincided with high temperatures. 
