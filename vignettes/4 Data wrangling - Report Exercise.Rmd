...
knitr::kable(data_aggregated[1:5,],  
...
data_aggregated_CO2_long <- data_aggregated[,2:7] |>
  pivot_longer(cols = everything(), names_to = "Variable", values_to = "Value")
data_aggregated_CO2_long$Variable <- factor(data_aggregated_CO2_long$Variable, levels = colnames(data_aggregated[,2:7]))


ggplot(data_aggregated_CO2_long, aes(x = factor(Variable), y = Value, fill = Variable)) +
  geom_boxplot() +
  theme_minimal() +
  theme(
...
#   labs(title = "", x = "treatments", y = "soil carbon concentrations [g C/m2]", fill = "Treatment") +
#   scale_fill_viridis_d(option = "plasma", labels = c("mean_ambient_CO2_early" = "Ambient Early",
#                                                      "mean_ambient_CO2_mid" = "Ambient Mid",
#                                                      "mean_ambient_CO2_late" = "Ambient Late",
#                                                      "mean_increased_CO2_early" = "Increased Early",
#                                                      "mean_increased_CO2_mid" = "Increased Mid",
#                                                      "mean_increased_CO2_late" = "Increased Late"))
# 
# 
...
Through averaging over all experiments we get a more representative picture of the effect of increased amtospheric carbon on soil organic matter (Table 3). These averages show an increase in the soil organic matter due to elevated CO2 levels from the first phase (0-3 years) to the second phase (3-6 years) by a factor of 10. However, after 6 years and longer, the soil organic matter concentration is less in the scenario of elevated CO2 compared to the ambient CO2 scenario, leading to a negative response ratio. 
